...
namespace OCEAdmin.Core.Missions
{
    ...
    {
        private static MissionHooks instance;
        public static MissionHooks Instance
        {
            get
            {
                if(instance == null)
                {
                    instance = new MissionHooks();
                }
                return instance;
            }
        }
        ...
        public MissionData getMultiplayerOptionsState()
        {
        ...
        {
            TaleWorlds.MountAndBlade.Mission.Current.ResetMission();
        }
        ...
        public void SetRoundTime(int roundTime)
        {
            ...
            MissionLobbyComponent mlc = TaleWorlds.MountAndBlade.Mission.Current.GetMissionBehavior<MissionLobbyComponent>();
        ...
        {
            MultiplayerWarmupComponent mwc = TaleWorlds.MountAndBlade.Mission.Current.GetMissionBehavior<MultiplayerWarmupComponent>();
        ...
        {
            MultiplayerWarmupComponent warmup = TaleWorlds.MountAndBlade.Mission.Current.GetMissionBehavior<MultiplayerWarmupComponent>();
        ...
        private void EndMissionThenStartMission(MissionData missionData)
        {
            ...
            TaleWorlds.MountAndBlade.Mission.Current.AddListener(listener);
      ...
      BasicCultureObject cultureLimit)
        {
            ...
            MatrixFrame spawnFrame = TaleWorlds.MountAndBlade.Mission.Current.GetMissionBehavior<SpawnComponent>().GetSpawnFrame(team, troopCharacter.HasMount(), true);
            ...
            AgentBuildData agentBuildData2 = agentBuildData1.InitialDirection(in local).TroopOrigin((IAgentOriginBase)new BasicBattleAgentOrigin(troopCharacter)).EquipmentSeed(TaleWorlds.MountAndBlade.Mission.Current.GetMissionBehavior<MissionLobbyComponent>().GetRandomFaceSeedForCharacter(troopCharacter, 0)).ClothingColor1(team.Side == BattleSideEnum.Attacker ? cultureLimit.Color : cultureLimit.ClothAlternativeColor).ClothingColor2(team.Side == BattleSideEnum.Attacker ? cultureLimit.Color2 : cultureLimit.ClothAlternativeColor2).IsFemale(troopCharacter.IsFemale);
        ...
        public Tuple<AgentBuildData, int> GetAgentBuildDataForPlayer(MissionPeer component)
        {
            ...
            if (agentVisualForPeer == null)
            {
                ...
                matrixFrame = TaleWorlds.MountAndBlade.Mission.Current.GetMissionBehavior<SpawnComponent>().GetSpawnFrame(component.Team, heroCharacter.Equipment.Horse.Item != null, false);
            }
            else
            {
            ...
            ref Vec2 local = ref vec2;
            return new Tuple<AgentBuildData, int>(agentBuildData1.InitialDirection(in local).IsFemale(component.Peer.IsFemale).BodyProperties(this.GetBodyProperties(component, basicCultureObject)).VisualsIndex(0).ClothingColor1(component.Team == TaleWorlds.MountAndBlade.Mission.Current.AttackerTeam ? basicCultureObject.Color : basicCultureObject.ClothAlternativeColor).ClothingColor2(component.Team == TaleWorlds.MountAndBlade.Mission.Current.AttackerTeam ? basicCultureObject.Color2 : basicCultureObject.ClothAlternativeColor2), num);
