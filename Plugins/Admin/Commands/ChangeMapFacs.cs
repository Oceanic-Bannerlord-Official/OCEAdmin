...
namespace OCEAdmin.Plugins.Admin
{
    class ChangeMapFacs : ICommand
    {
        ...
        public CommandFeedback Execute(NetworkCommunicator networkPeer, string[] args)
        {
            ...
            Tuple<bool, string> mapSearchResult = MissionHooks.Instance.FindSingleMap(mapSearchString);
            ...
            MissionHooks.Instance.ChangeMapAndFactions(mapName, faction1, faction2);
