...
namespace OCEAdmin.Plugins.Admin
{
    class ChangeMission : ICommand
    {
        ...
        public CommandFeedback Execute(NetworkCommunicator networkPeer, string[] args)
        {
            ...
            Tuple<bool, string> gameTypeSearchResult = MissionHooks.Instance.FindSingleGameType(gameTypeSearchString);
            ...
            Tuple<bool, string> mapSearchResult = MissionHooks.Instance.FindMapForGameType(gameTypeSearchResult.Item2,mapSearchString);
            ...
            Tuple<bool, string> faction1SearchResult = MissionHooks.Instance.FindSingleFaction(faction1SearchString);
            ...
            Tuple<bool, string> faction2SearchResult = MissionHooks.Instance.FindSingleFaction(faction2SearchString);
            ...
            MissionHooks.Instance.ChangeGameTypeMapFactions(gameType, mapName, faction1, faction2);
